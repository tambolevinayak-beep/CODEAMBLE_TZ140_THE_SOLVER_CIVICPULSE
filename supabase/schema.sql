...
create policy "Users can create own verification submissions" on public.verification_submissions
  for insert to authenticated
  with check ((select auth.uid()) = user_id);
create policy "Users can read own verification submissions" on public.verification_submissions
